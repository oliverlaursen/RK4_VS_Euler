...
if __name__ == '__main__':
	...
	draw_graph([case_2_rk4[1],case_2_em[1]],['RK4 af a(x)','EM af a(x)','a(x)'],0.3,P0[0],functions=[eksaktf])	# Tilfælde 2
	draw_graph([case_1_rk4[1],case_1_em[1]],['RK4 af a(x)','EM af a(x)','a(x)'],0.1,P0[0],functions=[eksaktf])	# Tilfælde 1
	draw_graph([case_3_rk4[1],case_3_em[1]],['RK4 af b(x)','EM af b(x)','b(x)'],0.1,P1[0],functions=[eksaktg]) # Tilfælde 3
	draw_graph([case_4_rk4[1],case_4_em[1]],['RK4 af b(x)','EM af b(x)','b(x)'],0.3,P1[0],functions=[eksaktg]) # Tilfælde 4
